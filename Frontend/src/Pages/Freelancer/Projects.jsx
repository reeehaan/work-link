...
const Projects = () => {
  ...
  const getRecentProjects = async () => {
    try {
      const apiUrl = "http://localhost:3000/api/project/all";
  ...
  return (
    <div className={styles.projectList}>
      <h1 className={styles.title}>Explore the latest job opportunities that align with your skills and profile to meet the demands of clients.</h1>
      {loading ? (
